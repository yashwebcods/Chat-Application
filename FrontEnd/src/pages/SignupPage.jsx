...
function SignupPage() {
  ...
  const validateForm = () => {
    ...
    if (!formData.fullName.trim()) return toast.error('Full is required');
  ...
  return (
    <div className='min-h-screen grid lg:grid-cols-2 mt-12'>
      ...
      <div className='flec flex-col justify-center items-center p-6 sm:p-12'>
        <div className='w-full max-w-md space-y-8'>
          ...
          <div className='text-center mb-8'>
            <div className='flex flex-col items-center gap-2 group'>
              ...
              <h1 className='text-base-content/60'>Get started wih your free account</h1>
            </div>
          </div>
          ...
          <div>
            Alread have an account <Link to="/login" className='link link-primary'>sign in</Link>
          </div>
        </div>
      </div>
      {/* Right side */}
      <AuthImagePattern
        title="Join us"
        subtitle="Connect with friend , share moments , stay in touch with message "
      />
    </div>
  )
}
